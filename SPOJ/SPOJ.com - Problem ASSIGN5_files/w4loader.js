...
rcw4.callbacks.handle_a = function(){
	...
	if(widget.className== 'open'){
		...
		var str = '';
		if(typeof rc_utm_source !== 'undefined'){
			str = '&utm_source=' + rc_utm_source;
		}
...
rcw4.init = function(){
	document.write(
		"<div id=\"rcv4_widget\">",
		"<a href=\"\" id=\"rcv4_handle_a\"><div id=\"rcv4_handle\"><span>Time for a new job?</span></div></a>",
		"<div id=\"rcv4_content\"></div><div id=\"rcv4_footer\">Powered by <a href=\"http://recruitcoders.com\" target=\"_blank\">Recruit Coders</a>&trade;</div>",
		"</div>"
	);
