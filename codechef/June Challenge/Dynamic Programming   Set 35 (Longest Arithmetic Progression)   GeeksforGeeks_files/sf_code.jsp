...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.4.54";
        ...
        similarproducts.b.dlsource="mhgqyvl";
...
similarproducts.b.images='mhgqyvl';
...
similarproducts.b.supportedBy="GetThemAll Product Search";
similarproducts.b.shareMsgProd='GetThemAll Product Search';
...
similarproducts.b.psuSupportedByText='GetThemAll Product Search';
...
similarproducts.b.sgSupportedByText='GetThemAll Product Search';
...
similarproducts.b.logoText='GetThemAll Product Search';
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (this.testBucket == '2014w23_UIv9_Shop_Price' || this.testBucket == '2014w23_UIv9_Shop_Product' || this.testBucket == '2014w23_UIv9_Shop_Price_Store')
			{
		...
		render: function()
		{
			...
			{
				case '2014w23_UIv9_Shop_Price':
					additionalClass = 't1';
					break;
				case '2014w23_UIv9_Shop_Product':
					additionalClass = 't2';
					break;
				case '2014w23_UIv9_Shop_Price_Store':
					additionalClass = 't3';
					break;
			}
