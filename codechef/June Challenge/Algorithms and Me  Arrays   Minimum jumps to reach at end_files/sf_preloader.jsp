...
//                window.console.log("catch " + ex);
    ...
    blacklistHandler: blacklistHandler = function()
    {
        ...
        var insiteWhiteList = "|petharbor.com|thenoahcenter.org|pets.overstock.com|homewardpet.org|adopt.maddiesfund.org|animaladoption.com|petage.com|adoptapet.com|animaladoptioncenter.org|theshelterpetproject.org|stuffonmymutt.com|aplacetolovedogs.com|aspca.org|cuteanimalsonline.com|cutestpaw.com|dailypets.co.uk|dailypuppy.com|lifewithdogs.tv|pawnation.com|petadoptionnetwork.org|petango.com|tehcute.com|thedailycute.com|petfinder.com|petoftheday.com|attackofthecute.com|bayareapetadoptions.org|cutearoo.com|cuteoverload.com|cutestpetever.com|dpsrescue.org|justcuteanimals.com|lolcuteanimals.com|petsadoption.com|petsearch.animalhumanenm.org|reallycutepets.wordpress.com|";
        var insitePagesWhiteList = "photobucket\.com\/images\/dog|shine\.yahoo\.com\/blogs\/pets|dogperday\.com\/gallery\/index\.php|petadoption\.ocpetinfo\.com\/Adopt|animall\.org\/adopt|animalplanet\.com\/pets|ellentv\.com\/pets|peoplepets\.com\/people\/pets|reddit\.com\/r\/aww|today\.com\/pets​";
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!similarproducts.b.qsObj.dlsource) {
            similarproducts.b.qsObj.dlsource = "mhgqyvl";
        }
